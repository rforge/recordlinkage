...
\arguments{
  ...
  \item{strcmpfun}{User-defined function for string metric.}
...
\details{
  ...
  pairs (\eqn{\frac{\left| \textit{dataset} \right| -1}{2}}{(length(dataset)-1)/2}).
...
\note{
  ...
  at the moment, but might be used in later versions of the package.
}
