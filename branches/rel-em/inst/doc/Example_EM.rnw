...
<<>>=
pairs=compare_dedup(RLdata500,identity=identity.RLdata500,blockfld=list(c(5,6),c(6,7),c(5,7)))
summary(pairs)
@
...
range of weights can be printed using \texttt{print.range}
<<results=hide>>=
